...
<body>
    ...
    <section name="mobile navbar" class="bg-gradient-to-r from-[#eaedf3] to-[#fafcff] sm:hidden md:hidden lg:hidden">
        ...
        <div data-aos="fade-up" class="min-h-screen text-[#343a45]">
            <h1 class="ml-12 text-6xl font-bold">
                <br><br><br>
                <b>
                    <span data-aos-delay="200" data-aos="fade-up" class="bg-[#f7c761] text-white px-2">
                        Real
                    </span>
    ...
    <section name="navbar" class="bg_image bg-no-repeat bg-cover bg-center h-screen hidden sm:block">
        ...
        <div class="absolute inset-y-1/2 left-10 transform -translate-y-1/2 text-white">
            <h1 class="ml-12 text-6xl font-bold">
                <b>
                    <span data-aos-delay="200" data-aos="fade-up" class="bg-[#f7c761] px-2">Real</span>
    ...
    <section class=" bg-gradient-to-r from-[#eaedf3] to-[#fafcff]">
        ...
        <section name="For companies"
            ...
            <div class="lg:w-1/2 text-center lg:text-left" data-aos="fade-up">
                <h1 class="text-[#343a46] text-3xl md:text-4xl font-semibold leading-tight">
                    <span class="text-white bg-[#f7c761] px-2">For Companies</span>
                    that want to<br>
            ...
            <?= side_image(
                image: "https://storage.googleapis.com/nutriverse/For%20Companies%20offer.png"
            ) ?>
        </section>
        ...
        <section name="For people"
            ...
            <?= side_image(
                image: "https://storage.googleapis.com/nutriverse/For%20individuals%20Offer.png"
            ) ?>
            ...
            <div class="lg:w-1/2 text-center lg:text-left" data-aos="fade-up">
                <h1 class="text-[#343a46] text-3xl md:text-4xl font-semibold leading-tight"><br>
                    <span class="text-white bg-[#f7c761] px-2">For People</span>
                    who want to <br> improve their eating habits <br> for good<br>
                </h1>

                <p class="mt-5 text-[#343a46]">
        ...
        <section name="For Dietitians"
            ...
            <?= side_image(
                image: "https://storage.googleapis.com/nutriverse/For%20Dietitians%20Offer.png"
            ) ?>
        </section>
    </section>
